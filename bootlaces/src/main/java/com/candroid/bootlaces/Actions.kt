 ...
 * [NotificationProxy.UpdateReceiver] registers with an intent filter for [Actions.ACTION_UPDATE]. [Actions.ACTION_UPDATE] is broadcast only from within the [bootNotification]
